...
<style>
  ...
  @media (max-width: 768px) {
    .nav-links .nav-link span:not(.inline-svg) {
      display: none;
    }
    .nav-links .nav-link {
      padding: 6px 8px !important;
    }
    .relative.rounded-3xl > div.p-10 {
  ...
  @media (max-width: 480px) {
    ...
    .relative.rounded-3xl .flex.items-center {
        ...
        <table class="w-full text-sm border-collapse min-w-[300px]">
          ...
          <tbody>
            ...
            <tr class="hover:bg-emerald-50/40 transition-colors">
              <td class="py-2 px-2 text-emerald-600 font-bold border-b" style="border-color:rgba(6,78,59,0.06);"><?= $no ?></td>
              <td class="py-2 px-2 text-slate-500 border-b" style="border-color:rgba(6,78,59,0.06);"><?= $k ?></td>
              <td class="py-2 px-2 text-slate-700 font-medium border-b" style="border-color:rgba(6,78,59,0.06);"><?= $v ?></td>
            </tr>
            <?php endforeach; ?>
          </tbody>
        </table>
