...
<div class="max-w-6xl mx-auto px-6 py-8">
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
    <?php foreach ([
      ['peta.php', 'Peta Sensor', 'Lihat posisi dan status 8 sensor di lapangan secara visual interaktif.', 'Buka Peta', '#15803D', 'green', '<polygon points="3 6 9 3 15 6 21 3 21 18 15 21 9 18 3 21"/><line x1="9" y1="3" x2="9" y2="18"/><line x1="15" y1="6" x2="15" y2="21"/>'],
      ['bps.php', 'Data BPS', 'Data luas panen, produktivitas, dan produksi padi dari BPS Jawa Tengah.', 'Lihat Data', '#1D4ED8', 'blue', '<rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 9h18M9 21V9"/>'],
      ['riwayat.php', 'Riwayat Data', 'Analitik historis pembacaan sensor dengan filter dan ekspor CSV.', 'Lihat Riwayat', '#6D28D9', 'violet', '<polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/>'],
