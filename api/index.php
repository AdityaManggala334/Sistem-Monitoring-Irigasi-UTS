      ...
      <table class="w-full text-sm sensor-table">
        <thead>
          <tr class="bg-gray-50 border-b border-gray-200">
            ...
            <th class="py-3 px-3 text-left">ID SENSOR</th>
            <th class="py-3 px-3 text-left">LOKASI</th>
            <th class="py-3 px-3 text-right w-20">DEBIT</th>
            <th class="py-3 px-3 text-right w-16">TMA</th>
            <th class="py-3 px-3 text-right w-16">SUHU</th>
            <th class="py-3 px-3 text-right w-20">LEMBAP</th>
            <th class="py-3 px-3 text-center w-24">STATUS</th>
            <th class="py-3 px-3 text-center w-28">WAKTU</th>
          </tr>
        </thead>
        <tbody id="isi-tabel">
          <tr><td colspan="9" class="text-center py-8 text-slate-400">Memuat data sensor...</td></tr>
        </tbody>
      </table>
    </div>
